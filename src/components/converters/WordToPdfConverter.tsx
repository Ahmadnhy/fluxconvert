      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 w-full py-8 sm:py-10 lg:py-12">
        ...
        {uploadedFiles.length === 0 ? (
          ...
          >
            ...
            >
              ...
              <p className="text-xs text-gray-500 mt-2 sm:mt-4">Supports .docx files up to 50MB</p>
            </div>
          </motion.div>
        ) : (
          <motion.div
        ...
        >
          ...
          <div className="text-center p-4">
            ...
            <p className="text-xs sm:text-sm text-gray-600">Convert your documents in seconds with our optimized engine</p>
          </div>
          <div className="text-center p-4">
            <div className="w-12 h-12 bg-[#5b8ba8]/10 rounded-full flex items-center justify-center mx-auto mb-3 icon-hover-float">
              <svg className="w-6 h-6 text-[#5b8ba8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-xs sm:text-sm text-gray-600">Maintain formatting, images, and layout in the converted PDF</p>
          </div>
        </motion.div>
      </main>
